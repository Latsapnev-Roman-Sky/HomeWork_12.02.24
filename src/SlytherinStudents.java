public class SlytherinStudents extends HogwartsStudents {
    ...
    public int sumBallsSlytherin() {
        int sum = 0;
        sum += getCunning()+getDetermination()+getAmbition();
        return sum;
    }

    public SlytherinStudents(String name, int magicPower, int transgression, int cunning, int determination, int ambition, int resourcefulness, int lustForPower) {
